...
plot(TwoDays4$DateTime2, TwoDays$Voltage, type = "l", 
     xlab = "datetime", ylab = "Voltage")
plot(TwoDays4$DateTime2, TwoDays4$Sub_metering_1, type = "l", 
     xlab = "", ylab = "Energy sub metering", col = "black")
lines(TwoDays4$DateTime2, TwoDays4$Sub_metering_2, type = "l", 
      xlab = "", ylab = "", col = "red") ## adds submetering 2 in red to graph
lines(TwoDays4$DateTime2, TwoDays4$Sub_metering_3, type = "l", 
      xlab = "", ylab = "", col = "blue") ## adds submetering3 in blue to graph
legend("topright", 
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lty = c(1, 1, 1), lwd = c(2, 2, 2), 
       col = c("black", "red","blue"), xjust = 1)
plot(TwoDays4$DateTime2, TwoDays$Global_reactive_power, type = "l", 
